...
class GroupCallActivity : AppCompatActivity(), RemoteParticipant.Listener,
    ...
    private val mTAG = GroupCallActivity::class.simpleName
    ...
    private val token: String =
        "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiIsImN0eSI6InR3aWxpby1mcGE7dj0xIn0..Yl6MOjLp8baEXJq6003FiJGoJPips611KpnJiIhE5yY"
    ...
    private var adapter: GroupCallingAdapter? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_group)

        localVideoView = findViewById<View>(R.id.local_video_view) as VideoView
...
//        thumbnail_video_view.setOnClickListener(this)
    ...
    private fun buildLocalVideoTrack() {
        localVideoTrack = when {
            isCamera2ApiSupported -> {
                val cameraCapture = Camera2Capturer(this, frontCameraId)
                cameraCapture.changeCaptureFormat(1080, 1920, 60)
                LocalVideoTrack.create(this, true, cameraCapture)
            }
            else -> {
                val cameraCapture = CameraCapturer(this, frontCameraId)
                cameraCapture.changeCaptureFormat(1080, 1920, 60)
                LocalVideoTrack.create(this, true, cameraCapture)
            }
        }
    ...
    private fun roomListener(): Room.Listener {
        return object : Room.Listener {
            ...
            override fun onConnectFailure(room: Room, twilioException: TwilioException) {
                ...
                connect(this@GroupCallActivity, token, this, roomName)
            }
            ...
            override fun onParticipantConnected(
                ...
                adapter = GroupCallingAdapter(remoteParticipant)
                recycler.layoutManager = GridLayoutManager(this@GroupCallActivity, 5)
                recycler.adapter = adapter
//                remoteParticipant.setListener(this@GroupCallActivity)
            }
...
//        pg.visibility = View.GONE
        ...
        try {
            publishLocalTracks()
            room.localParticipant?.setListener(this@GroupCallActivity)
    ...
    private fun unPublishVideoTrack(localVideoTrack: LocalVideoTrack?) =
        localVideoTrack?.let { localParticipant?.unpublishTrack(localVideoTrack) }

    private fun publishVideoTrack(localVideoTrack: LocalVideoTrack?) =
        localVideoTrack?.let { localParticipant?.publishTrack(localVideoTrack) }
...
//        switchPreview()
        isCameraOn = if (isCameraOn) {
            ...
            local_video_view.visibility = View.GONE
            ...
            camera_back.setPadding(80)
            local_video_view.visibility = View.VISIBLE
